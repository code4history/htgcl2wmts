...
const gcpString = htgclData.compiled.points.map((point) => {
    return `-gcp ${point[0][0]} ${point[0][1]} ${point[1][0]} ${point[1][1]}`;
}).join(' ');

const edgeString = htgclData.compiled.edgeNodes.map((point) => {
    return `-gcp ${point[0][0]} ${point[0][1]} ${point[1][0]} ${point[1][1]}`;
}).join(' ');

const gcpList = `${gcpString} ${edgeString}`;

fs.outputFileSync('./naramachi.gcp', gcpList);

//console.log(gcpList);

// gdal_translate -of GTiff  --optfile "./naramachi.gcp" "C:/Users/10467/OneDrive/MaplatEditor/originals/naramachi_yasui_bunko.jpg" "C:/Users/10467/AppData/Local/Temp/naramachi_yasui_bunko.jpg"
// gdalwarp -r cubic -tps -co COMPRESS=NONE  -t_srs EPSG:3857 "C:/Users/10467/AppData/Local/Temp/naramachi_yasui_bunko.jpg" "C:/Users/10467/OneDrive/MaplatEditor/originals/naramachi_yasui_bunko_modified.tif"
